  ...
  return (
    <div className="bg-white">
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        >
          <div
            className="relative left-[calc(70%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#055EB1] to-[#FFF9F9]  sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Yayasan Pendidikan Terpadu Quran Baitul Qurra&apos; Abdya
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              &quot;Tidak ada pemberian orang tua kepada anak yang lebih utama
              daripada pendidikan yang baik&quot;
            </p>
            <p className="mt-3 leading-6 text-gray-600 font-semibold">
              HR. At-Tirmidzi
            </p>
